...
# Dell consumer software to remove. Dell Command Update (the enterprise tool) and
# Dell Command Configure are intentionally NOT in this list ... they are the
# vendor lifecycle tools this baseline deploys.
$dellBloatPatterns = @(
    "SupportAssist",
    "Dell SupportAssist",
    "Dell Update",
