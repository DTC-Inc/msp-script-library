...
# Get all members of the Administrators group and clean up names
$AdminGroupMembers = (Get-LocalGroupMember -Group "Administrators").Name | ForEach-Object { $_ -replace '.*\\', '' }
