...
if ($iso -eq "download") {
    try {
        $iso = "$logFolder\VeeamBackup&Replication_12.1.2.172_20240515.iso"
        ...
        if (Test-Path $iso) {
            ...
            Start-BitsTransfer -Source "https://download2.veeam.com/VBR/v12/VeeamBackup&Replication_12.1.2.172_20240515.iso" -Destination $iso
