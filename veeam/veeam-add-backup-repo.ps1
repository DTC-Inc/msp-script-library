...
# Install Veeam PowerShell module if not already installed
if (-not (Get-Module -ListAvailable -Name VeeamPSSnapin)) {
    Install-Module -Name VeeamPSSnapin -Scope CurrentUser
}

# Import the Veeam PowerShell module
Import-Module -Name VeeamPSSnapin
